...
<html>
  ...
  <body>
      ...
      <div class="container-fluid">
    		...
    		<div class="row info" id="info">
      		...
      		<div class="col-sm-4 caixa" id="caixa3">
      			...
      			<center><a href="cadastro.php"><button class="banner-button banner-button-animation"><span>CADASTRE-SE</span></button></a></center>
    		  </div>
    		</div> <!-- fim info -->
    ...
    <script type="text/javascript" src="cssjs/main.js"></script> <!-- importa js -->
